      ...
      <div className="container p-8 mx-auto xl:px-0 !p-0">
        <div className="w-full max-w-2xl p-2 mx-auto rounded-2xl">
          <div className="mb-5">
            ...
            >
              Operation and development of APIs are currently fully funded by
              company Apitalks and its usage is for free.
            </div>
          </div>
          <div className="mb-5">
            <button
          ...
          <div className="mb-5">
            ...
            >
              <span>How I will know that data in API were updated?</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
                fill="currentColor"
            ...
            <div
              className="px-4 pt-4 pb-2 text-gray-500 dark:text-gray-300"
              id="headlessui-disclosure-panel-8"
            >
              All important information such as time of last update, license and
              other information are in response of each API call.
            </div>
          </div>
          <div className="mb-5">
            <button
            ...
            >
              <span>What happens in case we issue new version of API?</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
                fill="currentColor"
            ...
            <div
              className="px-4 pt-4 pb-2 text-gray-500 dark:text-gray-300"
              id="headlessui-disclosure-panel-10"
            >
              In case of major update that would not be compatible with previous
              version of API, we keep for 30 days both versions so you will have
              enough time to transfer to new version. We will inform you about
              the changes in advance by e-mail.
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
            <div className="lg:col-span-2">
              ...
              <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
                API Store provides access to European Open Data via scalable and
                reliable REST API interface.
              </div>
