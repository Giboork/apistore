    ...
    return (
        <nav className="container relative flex flex-wrap items-center justify-between p-8 pb-2 mx-auto lg:justify-between xl:px-0">
            <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                <a className="flex items-center space-x-2 text-2xl font-medium dark:text-gray-100 hover:text-blue-500" href="/">
                    <span><img src="/img/logo.svg" alt="N" height={48} className="w-12" /></span>
                    <span>API Store ®</span>
                </a>
                ...
                >
                    ...
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" clip-rule="evenodd" d="M18.278 16.864a1 1 0 0 1-1.414 1.414l-4.829-4.828-4.828 4.828a1 1 0 0 1-1.414-1.414l4.828-4.829-4.828-4.828a1 1 0 0 1 1.414-1.414l4.829 4.828 4.828-4.828a1 1 0 1 1 1.414 1.414l-4.828 4.829 4.828 4.828z"></path></svg>
                    </svg>
                ...
                <div className="flex flex-wrap w-full my-5 lg:hidden" id="headlessui-disclosure-panel-2">
                    ...
                    <a className="w-full px-4 py-2 -ml-4 text-gray-500 rounded-md dark:text-gray-300 hover:text-blue-500 focus:text-blue-500 focus:bg-blue-100 dark:focus:bg-gray-800 focus:outline-none dark:focus:bg-trueGray-700"  target="_blank" href="https://www.apitalks.com/public-apistore-en/">About Apitalkss</a>
